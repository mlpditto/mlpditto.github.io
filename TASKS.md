...
*   **B2B Wholesale Portal (ecom.html):**
    ...
    -   **Advanced Admin Management:** เพิ่มช่องข้อมูล Lot, Exp และ Stock ให้ Admin จัดการได้โดยตรงใน Modal
    -   **Multi-Unit Pricing:** รองรับการเพิ่มราคาแบบแยกตามหน่วย (เช่น ต่อแผง, ต่อกล่อง) พร้อมแสดงผลสรุปบนหน้าบัตรสินค้า (Product Card)
